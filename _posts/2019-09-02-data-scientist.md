...
Chúng ta thường xem nhẹ việc xây dựng một pipeline tốt và thường tập trung thời gian vào việc xây dựng mô hình machine learning ngày từ lúc đầu. Lý do đơn giản bởi vì chúng ta yêu thích việc xây dựng một hình thông minh hơn là làm những công việc nhàn chán như xây dựng một quy trình để kết nối các bước như thu thập dự liệu hàng ngày, xử lý dữ liệu, train, đổ kết quả dự đoán lại cơ sở dữ liệu. và cho phép chúng có thể chạy được hàng ngày mà không cần sự tác động của chúng ta. 
