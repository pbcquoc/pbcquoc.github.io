...
Ngoài ra, các bạn cần lưu ý tham số stride, thể hiện số pixel bạn cần phải dịch chuyển mỗi khi trượt bộ filter qua bức ảnh. Ở ví dụ bên dưới, vbộ filter sẽ dịch chuyển 2 pixel mỗi lần áp dụng phép convolution.
