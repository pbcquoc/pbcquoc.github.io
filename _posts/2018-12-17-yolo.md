...
* Ô vuông đó có chứa object nào hay không. Ô vuông có chứa object được quy định khi tâm của đối tượng bất kì nằm trong ô vuông đó.
...
* Lớp của object đó
Như vậy với mỗi ô vuông chúng ta cần dữ đoán một vector có (1+4*nbox+nclass) chiều.
<div class="img-div" markdown="0">
