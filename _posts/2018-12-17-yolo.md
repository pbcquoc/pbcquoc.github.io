...
Trong đó:
<div class='row'>
<span class="col-sm-12" id="indicator_function" style="font-size:100%">: bằng 1 nếu ô vuông đang xét có object ngược lại bằng 0</span>
</div>

<div class='row'>
<span class="col-sm-12" id="p_function" style="font-size:100%">: là xác xuất có điều của lớp c mà mô hình dự đoán</span>
</div>
