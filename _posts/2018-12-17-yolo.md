...
Trong đó:
<span class="col-sm-12" id="indicator_function" style="font-size:150%"></span>: bằng 1 nếu ô vuông đang xét có object ngược lại bằng 0

<span class="col-sm-12" id="p_function" style="font-size:150%"></span>: là xác xuất có điều của lớp c mà mô hình dự đoán
