...
## Cấu trúc CNN
CNN bao gồm tập hợp các lớp cơ bản bao gồm: convolution layer + nonlinear layer, pooling layer, fully connected layer. Một ảnh được biểu diễn bằng ma trận được lan truyền lần lượt qua tập hợp các lớp trên để tính được xác xuất của ảnh đó chứa vật thế gì. 
